...
class ConversationList extends React.Component {
  ...
  renderDeletePopup = () => {
    ...
    <div className="deleteconversation-container">
        <span className="deleteconversation-title">All messages with {popupDetails.friendName} will be deleted. <br/> Are you sure?</span>
    ...
    return <div className="convList-container">
           { !this.props.loading ? (
             this.state.conversations.map(conversation => {
              return(
                <div
                  className="conversation-listItem-container"
                ...
                >
                  ...
                  <div className="conversation-action-wrapper">
                      <span
                        ...
                        onClick={()=> {                        
                          this.setState({showDeletePopup: true, popupDetails: {friendName: conversation.recipients_info.name, friendId: conversation.recipients_info._id}})
                        }}
